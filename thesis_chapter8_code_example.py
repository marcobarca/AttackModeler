...
def main():
    ...
    stepModel_path = './data/input_data/chapter8_example/StepModel2.json'
    hidden_paths_file = './data/input_data/chapter8_example/hidden_paths.txt'

    OUTPUT_PATH = "./data/output_data/chapter8_example/"
    ...
    #attack_with_digital_artefacts.save_as_pickle("node_model", OUTPUT_PATH)

    # Load attack (with digital artefacts) from pickle file as a NodeModel
    attack = Attack.from_pickle("./data/output_data/chapter8_example/node_model.pkl")

    # # Plot the graph
    #attack.plot()

    # Save attack as NodeModel json file
    #node_model = attack.save_as_json("node_model", OUTPUT_PATH)
